...
- (BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString* logText = [NSString stringWithFormat:@"willFinishLaunchingWithOptions: startLocation %@ triggeredNotification %@ applicationState: %ld", startLocation, [triggeredNotification alertBody], [application applicationState]];
    DLog(@"%@",logText);
...
{
    NSString* logText = [NSString stringWithFormat:@"applicationDidReceiveLocalNotification: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    NSString* logText = [NSString stringWithFormat:@"applicationWillResignActive: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    NSString* logText = [NSString stringWithFormat:@"applicationDidEnterBackground: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    NSString* logText = [NSString stringWithFormat:@"applicationWillEnterForeground: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    NSString* logText = [NSString stringWithFormat:@"applicationDidBecomeActive: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    NSString* logText = [NSString stringWithFormat:@"applicationWillTerminate: applicationState: %ld", [application applicationState]];
    DLog(@"%@",logText);
    [[NSNotificationCenter defaultCenter] postNotificationName:kLogToTextViewNotif
                                                        object:self
                                                      userInfo:[NSDictionary dictionaryWithObject:logText
...
//        DLog(@"lastStationUpdate: %@", tempStation.lastStationUpdate);
        ...
        else
        {
            ...
            DLog("Invalid station coordinate: stationID %ld, %@, coord %f, %f", (long)tempStation.stationID, tempStation.name, tempStation.latitude, tempStation.longitude);
        }
    }
